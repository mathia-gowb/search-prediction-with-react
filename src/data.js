...
export function searchAndCreateElements(value){
    ...
    if(value){
        ...
        //
        console.log(value,<li>{value}</li>)
        results=foundNames.map(name=><li className="results-item">Suggested Name Is {/* {name.replace(value,<span className="shade">{value}</span>)} */} </li>)
